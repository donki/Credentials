...
public class LocalizationService : ILocalizationService
{
    ...
    private static readonly Dictionary<string, string> English = new()
    {
        ...
        ["ExtStepsStore"] = "The extension is in the {0} add-ons store. Its page will open: click “Get” and then “Add extension”. As soon as it connects, it will show as installed here.",
        ["ExtOpenStore"] = "Open the store",
        ...
        ["TrustDevice"] = "Trust this user on this device",
        ["TrustDeviceHint"] = "The vault opens on its own without asking for the master password, but only for your user on this device: another user of the same PC or phone, or another device, still needs it. The key is kept protected by your system account.",
        ["TrustDeviceConfirm"] = "Anyone who signs in to this device with your user will be able to open your passwords without the master password. Turn it on only if nobody else uses your user here.",
        ...
        ["TotpShowSeed"] = "Show the secret key",
        ["TotpSeed"] = "Secret key (to set up this code in another app)",
        ["CopiedSeed"] = "Secret key copied",
        ["TotpQrHint"] = "Scan it with another authenticator app to get the same codes there.",
        ["RecoveryTitle"] = "Backup codes",
        ["RecoveryNone"] = "None saved. Paste the ones the site gave you when you turned on two-factor: they let you back in if you lose the codes.",
        ["RecoveryCount"] = "{0} saved, {1} unused. Each one works once: tick it when you use it.",
        ["RecoveryPlaceholder"] = "Paste the backup codes, one per line",
        ["RecoveryAdd"] = "Add codes",
        ["RecoveryShow"] = "Show the backup codes",
        ["RecoveryUsed"] = "Used",
        ["CopiedRecovery"] = "Backup code copied",
        ["TotpSeconds"] = "{0} s",
        ["Fields"] = "Extra fields",
        ["FieldName"] = "Name",
        ["FieldValue"] = "Value",
        ...
        ["TutExtBodyStore"] = "The extension fills in and saves passwords in {0} and gives you each site's verification code (TOTP).\n\nIt is published in the {0} add-ons store: the button opens its page, where you click “Get” and then “Add extension”. As soon as the extension connects, this step is marked as done.",
    ...
    private static readonly Dictionary<string, string> Spanish = new()
    {
        ...
        ["ExtStepsStore"] = "La extensión está en la tienda de complementos de {0}. Se abrirá su página: pulsa «Obtener» y después «Agregar extensión». En cuanto conecte, aquí saldrá como instalada.",
        ["ExtOpenStore"] = "Abrir la tienda",
        ...
        ["TrustDevice"] = "Confiar en este usuario y dispositivo",
        ["TrustDeviceHint"] = "La bóveda se abre sola, sin pedir la contraseña maestra, pero solo para tu usuario en este dispositivo: otro usuario del mismo PC o móvil, u otro dispositivo, la sigue necesitando. La clave queda guardada protegida por tu cuenta del sistema.",
        ["TrustDeviceConfirm"] = "Quien entre en este dispositivo con tu usuario podrá abrir tus contraseñas sin la contraseña maestra. Actívalo solo si nadie más usa tu usuario aquí.",
        ...
        ["TotpShowSeed"] = "Ver la semilla",
        ["TotpSeed"] = "Semilla (clave secreta, para dar de alta este código en otra app)",
        ["CopiedSeed"] = "Semilla copiada",
        ["TotpQrHint"] = "Escanéalo con otra app de autenticación para tener allí los mismos códigos.",
        ["RecoveryTitle"] = "Códigos de respaldo",
        ["RecoveryNone"] = "Ninguno guardado. Pega los que te dio el sitio al activar el segundo factor: sirven para volver a entrar si pierdes los códigos.",
        ["RecoveryCount"] = "{0} guardados, {1} sin usar. Cada uno vale una vez: márcalo al usarlo.",
        ["RecoveryPlaceholder"] = "Pega los códigos de respaldo, uno por línea",
        ["RecoveryAdd"] = "Añadir códigos",
        ["RecoveryShow"] = "Ver los códigos de respaldo",
        ["RecoveryUsed"] = "Usado",
        ["CopiedRecovery"] = "Código de respaldo copiado",
        ["TotpSeconds"] = "{0} s",
        ["Fields"] = "Campos extra",
        ["FieldName"] = "Nombre",
        ["FieldValue"] = "Valor",
        ...
        ["TutExtBodyStore"] = "La extensión rellena y guarda contraseñas en {0} y te da el código de verificación (TOTP) de cada web.\n\nEstá publicada en la tienda de complementos de {0}: el botón abre su página, donde pulsas «Obtener» y después «Agregar extensión». En cuanto la extensión conecte, este paso se marca como hecho.",
