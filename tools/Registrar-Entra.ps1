<#
.SYNOPSIS
    Crea en Entra ID el registro de aplicacion que necesita sOC Credentials (OneDrive).
...
.EXAMPLE
    .\Registrar-Entra.ps1
    .\Registrar-Entra.ps1 -Nombre "sOC Credentials" -Tenant contoso.onmicrosoft.com
#>

[CmdletBinding()]
param(
    [string]$Nombre = 'sOC Credentials',
    ...
    #
    [string[]]$Redirecciones = @('http://127.0.0.1/auth/', 'com.socratic.credentials://auth'),
...
# Los permisos que se piden: solo la carpeta de la aplicacion en OneDrive y la identidad basica.
$graph = @{
    resourceAppId = '00000003-0000-0000-c000-000000000000'
    resourceAccess = @(
        @{ id = '8019c312-3263-48e6-825e-2b833497195b'; type = 'Scope' }  # Files.ReadWrite.AppFolder
...
Write-Host "  <CrMicrosoftClientId>$($app.appId)</CrMicrosoftClientId>"
Write-Host ''
